  ...
  return (
    <Box pt="160px" pb={20} position="relative" zIndex={10} minH="80vh">
      <Container maxW="3xl">
        ...
        >
          <Heading as="h1" size="xl" mb={6} color="gray.900">Kebijakan Privasi</Heading>
          ...
          <VStack spacing={4} align="start" color="gray.600" fontSize="md" lineHeight="tall">
            ...
            <Heading as="h2" size="md" color="orange.500" mt={4}>1. Informasi yang Kami Kumpulkan</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.500" mt={4}>2. Penggunaan Informasi</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.500" mt={4}>3. Keamanan Data</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.500" mt={4}>4. Pembagian Data kepada Pihak Ketiga</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.500" mt={4}>5. Hubungi Kami</Heading>
            <Text>
