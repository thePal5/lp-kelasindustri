  ...
  return (
    <Box pt="160px" pb={20} position="relative" zIndex={10} minH="80vh">
      <Container maxW="3xl">
        ...
        >
          <Heading as="h1" size="xl" mb={6} color="white">Syarat & Ketentuan</Heading>
          ...
          <VStack spacing={4} align="start" color="whiteAlpha.800" fontSize="md" lineHeight="tall">
            ...
            <Heading as="h2" size="md" color="orange.400" mt={4}>1. Eligibilitas Peserta</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.400" mt={4}>2. Pendaftaran dan Data Peserta</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.400" mt={4}>3. Kewajiban Peserta</Heading>
            <Text>
              Peserta wajib:
            ...
            <Heading as="h2" size="md" color="orange.400" mt={4}>4. Hak Kekayaan Intelektual</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.400" mt={4}>5. Perubahan Program</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.400" mt={4}>6. Program Job Connector</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.400" mt={4}>7. Hukum yang Berlaku</Heading>
            <Text>
            ...
            <Heading as="h2" size="md" color="orange.400" mt={4}>8. Hubungi Kami</Heading>
            <Text>
